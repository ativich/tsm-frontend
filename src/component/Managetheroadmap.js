  ...
  return (
    <div>
      <header>
          ...
          <div className="travelmap">
            ...
            {istravelmapOpen && (
              <div id="mytravelmap" className="travelmap-content" >
                ...
                <div style={{marginTop:"5px"}}><a href="/Managetheroadmap" style={{color:"white"}} >จัดการแผนที่การเดินรถ</a></div>
              </div>
            )}
          </div>
        ...
        <body className='body'>
        จัดการแผนที่การเดินรถ
        </body>

    </div>
  );
};
export default Managetheroadmap;