          ...
          <div className="analysis">
            ...
            {isanalysisOpen && (
              <div id="myanalysis" className="analysis-content">
                ...
                <div style={{marginTop:"5px"}}><a href="/Driverinformation" style={{color:"white"}} >ข้อมูลพนักงานขับรถ</a></div>
      ...
      <div >
        <body className='body' style={{marginLeft:"5%"}} >
          ...
          <div className='Messagedata'>
            <p style={{marginLeft:"15px",marginRight:"15px",padding:"30px 5px 10px 40px",fontSize:"20px"}}><b>ข้อมูลพนักงานขับรถ</b></p>
