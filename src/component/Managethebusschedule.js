            ...
            <div onClick={toggleoperation} className="operation button" >
              ...
              {isoperationOpen && (
                <div id="myoperation" className="operation-content">
                  ...
                  <div style={{marginTop:"5px"}}><a href="/Managethebusschedule" style={{color:"white"}}>จัดการตารางการเดินรถ</a></div>
                </div>
              )}
          </div>
          ...
          <dix>
            <div className='spean '>
              <div style={{marginTop:"20px",marginLeft:"-50px"}}>
                ...
                <div className='spean mapleft'><b style={{fontSize:"16px"}}>จุดเกิดอุบัติเหตุ</b><span><i style={{color:"red"}} class="bi bi-geo-alt"></i></span></div>
              </div>
              <div className='spean '>
                <div style={{marginTop:"20px"}}>
                  <div className='spean mapleft'><b style={{fontSize:"16px"}}>สถานที่ปลายทาง</b><span><i class="bi bi-camera-fill"></i></span></div>
                </div>
                <div>
                  <div className='mapleft0' style={{marginTop:"30px",marginRight:"-30px"}}>
                      <b>
...
export default Managethebusschedule;